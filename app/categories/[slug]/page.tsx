...
export default async function CategoryPage({ params, searchParams }: CategoryPageProps) {
  ...
  // Fetch posts by category from Strapi with error handling
  const postsData = await getPostsByCategory(params.slug, currentPage, pageSize)
  ...
  // Get category name from the first post or use the slug
