...
export default async function TagPage({ params, searchParams }: TagPageProps) {
  ...
  const postsData = await getPostsByTag(params.slug, currentPage, pageSize)
      ...
      {posts.length > 0 ? (
        ...
        <div className="text-center p-8 border border-dashed rounded-lg">
          <p className="text-muted-foreground">
            No posts found for this tag. Please check your Strapi connection or add some posts with this tag.
          </p>
        </div>
      )}
